       ...
       tv2.setText("Score:  0");
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            if(res == Integer.parseInt(c.getString(6))){
                Toast.makeText(getApplicationContext(),"Correct Answere !",Toast.LENGTH_SHORT).show();
                scr+=nscr;
                tv2.setText("Score: "+scr);
            }
            else{
                Toast.makeText(getApplicationContext(),"Incorrect Answere!",Toast.LENGTH_SHORT).show();
            }
            if(questions<10){
                c.moveToNext();
                rg.removeAllViews();
